...
export function Features() {
  return (
    <section id="features" className="relative z-[1] mx-auto mt-[130px] max-w-[1200px] px-[22px]">
      ...
      {/* One signature feature gets the room; the other two support it.
          This replaces the old 3-equal-card grid, which gave every point
          the same weight regardless of how much it mattered. */}
